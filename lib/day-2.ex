...
game_results_by_color = Enum.map(list, &Day2.read_input/1)

result = Enum.reduce(game_results_by_color, 0, fn [game_number, color_count], acc ->
  if (color_count["red"] <= 12) and (color_count["green"] <= 13) and (color_count["blue"] <= 14) do
    updated_acc = game_number + acc
