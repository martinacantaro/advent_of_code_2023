defmodule Day3 do
  # for each line, save positions at which there are symbols * = # $ % + etc (characters that are not numbers or ".")
  # result -> [1, 3], [1, 7], [1, 50]...[line, position]
  # then save positions at which there are numbers [2, 2]
  # check: for each number position, there should be a symbol at the coordinates where X-1, X or X+1 and Y-1, Y or Y+1
  # Keep numbers that meet this criteria
